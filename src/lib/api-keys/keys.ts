...
//
// Why the `tachyel_live_` prefix
//   - Self-identifying: a leaked string is instantly recognisable as
//     a Tachyel CRM key (handy for secret-scanners like GitGuardian).
//   - Forward-compatible: leaves room for a `tachyel_test_` variant if
...
export const API_KEY_PREFIX = 'tachyel_live_';
