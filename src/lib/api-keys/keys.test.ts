...
describe('hashApiKey', () => {
  it('is deterministic', () => {
    expect(hashApiKey('tachyel_live_abc')).toBe(hashApiKey('tachyel_live_abc'));
  });

  it('differs for different inputs', () => {
    expect(hashApiKey('tachyel_live_abc')).not.toBe(hashApiKey('tachyel_live_abd'));
  });
});
...
describe('timingSafeHexEqual', () => {
  it('is true for identical digests', () => {
    const h = hashApiKey('tachyel_live_xyz');
